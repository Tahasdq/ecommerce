...
const Header = () => {
  ...
  return (
    <Card className="flex flex-row justify-between rounded-none md:justify-center">
            ...
            return (
              <NavigationMenuItem key={index}>
                ...
                {item.trigger ? (
                  ...
                  <NavigationMenuLink asChild><Link href="/sale">{item?.name}</Link></NavigationMenuLink>
                )}
              </NavigationMenuItem>
            );
          })}
